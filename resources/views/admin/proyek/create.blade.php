                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.proyek.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nama_pekerjaan" class="block mt-1 w-full" type="text"
                                name="nama_pekerjaan" :value="old('nama_pekerjaan')" required autofocus />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="nomor_proyek" class="block mt-1 w-full" type="text"
                                    name="nomor_proyek" :value="old('nomor_proyek')" />
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="tanggal_proyek" class="block mt-1 w-full" type="date"
                                    name="tanggal_proyek" :value="old('tanggal_proyek')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nilai_proyek" class="block mt-1 w-full" type="number" name="nilai_proyek"
                                :value="old('nilai_proyek', 0)" required min="0" />
                            <x-input-error :messages="$errors->get('nilai_proyek')" class="mt-2" />
                        </div>

                        <!-- COGS -->
                        <div class="mb-4">
                            <x-input-label for="cogs" :value="__('COGS / Batas Biaya (Rp)')" />
                            <x-text-input id="cogs" class="block mt-1 w-full" type="number" name="cogs"
                                :value="old('cogs', $proyek->cogs ?? 0)" required min="0" />
                            <x-input-error :messages="$errors->get('cogs')" class="mt-2" />
                        </div>
